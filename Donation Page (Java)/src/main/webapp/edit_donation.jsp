                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="name" value="<%= session.getAttribute("name") %>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="input--style-5" name="description" rows="4" cols="45" required><%= session.getAttribute("description") %></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- <div class="form-row">
                      ...
                      <!--   <div class="form-row">
                        ...
                        <div class="form-row">
                         ...
                         <div class="form-row">
                           ...
                           <div class="value">
                               <div class="input-group">
                                   <input class="input--style-5" type="date" name="start_date" value="<%= session.getAttribute("start") %>" required>
                               </div>
                           </div>
                        </div>
                        <div class="form-row">
                           ...
                           <div class="value">
                               <div class="input-group">
                                   <input class="input--style-5" type="date" name="end_date" value="<%= session.getAttribute("end") %>" required>
                               </div>
                           </div>
                        </div>
                        <div class="form-row">
                        ...
                        <input class="hidden" name="id" value="<%= session.getAttribute("id") %>" style="visibility:hidden">
                        <div>
